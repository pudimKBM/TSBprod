...
if (!defined("PJ_DB")) define("PJ_DB", "db_atletaco");
if (!defined("PJ_PREFIX")) define("PJ_PREFIX", "");
if (!defined("PJ_INSTALL_FOLDER")) define("PJ_INSTALL_FOLDER", "/");
if (!defined("PJ_INSTALL_PATH")) define("PJ_INSTALL_PATH", "C:/Users/anton/Desktop/TBSprod/");
if (!defined("PJ_INSTALL_URL")) define("PJ_INSTALL_URL", "http://localhost/");
if (!defined("PJ_SALT")) define("PJ_SALT", "K1APZ1GP");
